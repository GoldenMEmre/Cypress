...
describe('Negatif Login Test', () => {
    it('Test İşlemi', () => {
        cy.visit('http://www.automationexercise.com')  //Burada ilgili sayfaya gidildi
        cy.get('.shop-menu > .nav > :nth-child(4) > a').click() //Login sayfasına gidebilmek için alınan locate click edildi
